...
router.post('/posts', validation({ body: postSchema }), (req, res) => {
...
router.put('/posts/:id', validation({ params: postIdSchema, body: postSchema }), (req, res) => {
...
router.patch('/posts/:id', validation({ params: postIdSchema, body: postSchema }), (req, res) => {
  const { id } = req.params;
